<x-app-layout>
    <div id="add-sources" class="my-3 split">
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="card shadow mb-4 mt-4">
                        ...
                        <form method="POST" action="{{ route('sources.store') }}" style="padding: 30px;">
                            @csrf
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12 mb-3">
                                    ...
                                    >
                                        ...
                                        <option value="platforms" {{ old('source_type') == 'platforms' ? 'selected' : '' }}>Platforms</option>
                                        <option value="contest" {{ old('source_type') == 'contest' ? 'selected' : '' }}>Contest</option>
                                    </select>
                                    @error('source_type')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
