<x-app-layout>
    <div id="edit-sub-departments" class="my-3 split">
        <div class="container-fluid">
            <div class="row">
                <div class="col-sm-12">
                    <div class="card shadow mb-4 mt-4">
                        <div class="card-header py-3 table-heading">
                            <h6>Edit Sub-Department</h6>
                        </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12 mb-3">
                                    ...
                                    <select class="form-control @error('department_id') is-invalid @enderror"
                                        ...
                                        <option value="{{ $department->id }}"
                                            {{ old('department_id', $subDepartment->department_id) == $department->id ? 'selected' : '' }}>
                                            {{ $department->name }}
                                        </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="col-md-12 mb-3">
                                    ...
                                    <textarea class="form-control @error('description') is-invalid @enderror"
                                        ...
                                        rows="6">{{ old('description', $subDepartment->description) }}</textarea>
                                    @error('description')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
