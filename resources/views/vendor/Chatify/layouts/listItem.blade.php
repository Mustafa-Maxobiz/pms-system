...
<table class="messenger-list-item contact-item" data-channel="{{ $channel->id }}">
    <tr data-action="0">
        ...
        style="background-image: url('{{ $user->profile_picture ? asset('public/' . $user->profile_picture) : $user->avatar }}');">
        </div>
        </td>
        {{-- center side --}}
        <td>
...
<table class="messenger-list-item contact-item" data-channel="{{ $channel->id }}">
    <tr data-action="0">
        ...
        <td style="position: relative">
            <div class="avatar av-m"
                 style="background-image: url('{{ $channel->profile_picture ? asset('public/' . $channel->profile_picture) : $channel->avatar }}');">
            </div>
        </td>
        {{-- center side --}}
        <td>
