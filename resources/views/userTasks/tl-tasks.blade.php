                ...
                <div class="col-sm-12">
                    ...
                    <div class="card shadow mb-4 mt-4">
                        <div class="card-header p-3 table-heading">
                            <h6>Tasks Completed But Verification Pending</h6>
                        </div>
                        <div class="p-0">
                    ...
                    <div class="card shadow mb-4 mt-4">
                        <div class="card-header p-3 table-heading">
                            <h6>Tasks Assigned to Team Members</h6>
                        </div>
                        <div class="p-0">
                            <div class="table-responsive">
    ...
    @section('scripts')
        ...
        <script>
            ...
            $(document).ready(function() {
                ...
                // Reload DataTable every 5 seconds
                setInterval(function() {
                    table.ajax.reload(null, false); // `false` to retain pagination state
                }, 20000);
                ...
                $('#all-task-assigned-table').DataTable({
                    ...
                    columns: [{
                        ...
                        // Action Column to link to task details
                        {
                            ...
                            name: 'id',
                            render: function(data) {
                                return '<button class="btn btn-info bg-info btn-sm view-task-details" data-id="' +
                                    data + '">View Details</button>';
                            },
                            orderable: false,
                            searchable: false
                    ...
                    "fnRowCallback": function(nRow, aData, iDisplayIndex, iDisplayIndexFull) {
                        if (aData.task_status_logs.length !== 0) {
                            ...
                            if (status.title === 'Delayed') { // Fixed 'Daley' typo
                                $('td', nRow)
