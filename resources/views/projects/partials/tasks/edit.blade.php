                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12 mb-3 position-relative">
                                            ...
                                            <div class="input-group">
                                                <input type="text" class="form-control" id="task_time"
                                                    name="task_time" value="{{ $task->total_time }}"
                                                    placeholder="00:00:00" step="any" autocomplete="off" />
                            ...
                            <div class="col-6 p-4">
                                ...
                                <div class="row">
                                    <form id="conversation-form" class="p-4" method="POST"
                                        ...
                                        <div class="col-md-12 mb-3">
                                            <label for="description_conversation"
                                        ...
                                        <div class="col-md-12 mb-3">
                                            <label for="attachments_conversation"
                                                class="form-label">Attachments</label>
                                            <input type="file"
                                                class="form-control @error('attachments') is-invalid @enderror"
                                                id="attachments_conversation" name="attachments_conversation[]"
                                                multiple accept=".jpg,.jpeg,.png,.pdf,.doc,.docx,.zip">
                                            @error('attachments')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
    ...
    @section('scripts')
        ...
        <script>
            ...
            document.addEventListener("DOMContentLoaded", function() {
                let taskTimeInput = document.getElementById('task_time');
                let toggleButton = document.getElementById('toggle_task_time');
                let originalValue = "{{ $task->total_time }}";
                let isCleared = false;

                toggleButton.addEventListener('click', function() {
                    if (!isCleared) {
                        taskTimeInput.value = '00:00:00';
                        toggleButton.innerHTML = '<i class="fas fa-undo"></i>'; // Revert icon
                        toggleButton.classList.remove('btn-outline-danger');
                        toggleButton.classList.add('btn-outline-primary');
                    } else {
                        taskTimeInput.value = originalValue;
                        toggleButton.innerHTML = '<i class="fas fa-trash"></i>'; // Delete icon
