<x-app-layout>
    <div id="add-task-types" class="my-3 split">
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="card shadow mb-4 mt-4">
                        ...
                        <form method="POST" action="{{ route('task-types.store') }}" style="padding: 30px;">
                            @csrf
                            <div class="row">
                                ...
                                <div class="col-md-12 mb-3">
                                    <label for="title" class="form-label">Avg Time<span class="text-danger">*</span></label>
                                    <input
                                        type="number"
                                        class="form-control @error('title') is-invalid @enderror"
                                        id="evg_time"
